...
<li class="answer"> $P(M_1\text{ is good}~|~\text{data}) = 0.571$, $P(M_2\text{ is good}~|~\text{data}) = 0.429$ </li>
...
prior2 <- bandit_posterior(data1) %>% bandit_posterior(data2, prior=.)
prior3 <- bandit_posterior(data3, prior=prior2)
prior4 <- bandit_posterior(data4, prior=prior3)
bandit_posterior(data5, prior=prior4)
```
```{r concision-fives}
data0 <- data.frame(machine=c(1,1,2,2,2), outcome=c("W","W","W","W","L"))
bandit_posterior(data0)
```
...
```{r q-six}
data1 = data.frame(machine=c(2L), outcome=c("W"))
data2 = data.frame(machine=c(2L), outcome=c("W"))
data3 = data.frame(machine=c(2L), outcome=c("L"))
data4 = data.frame(machine=c(1L), outcome=c("W"))
data5 = data.frame(machine=c(1L), outcome=c("W"))
...
```
```{r consision-six}
dataA <- data.frame(machine=c(2,2,2,1,1), outcome=c("W","W","L","W","W"))
bandit_posterior(dataA)
```
...
bandit_posterior(data = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L), outcome = c("W", "L", "W", "L", "L", "L", "L", "W", "L", "W", "L", "W", "W", "L", "L", "L", "W", "W", "L", "L", "L", "L", "L", "L", "L", "W", "L", "W", "L", "W", "W", "W", "L", "W", "L", "L", "L", "L", "W", "L", "W", "L", "L", "L", "W", "W", "L", "W", "L", "L", "L", "W", "W", "L", "L", "W", "L", "L", "L", "W")))
```
...
```{r hikeeba}
mydata = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "W", "L", "L", "L", "L", "L", "W", "L", "L", "W", "L", "W", "L", "L", "L", "W", "L", "W", "W", "W", "W", "W", "W", "L", "L", "W", "W", "W", "L", "W", "L", "W", "L", "L", "W", "W", "L", "L", "W", "W", "L", "L", "L", "L", "L", "W", "L", "L", "L"))
plot_bandit_posterior(mydata)
```
...
<li class="answer"> All of the above </li>
</ol>
