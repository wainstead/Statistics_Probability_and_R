...
<li><span class="answer">A poll conducted by WIN-Gallup International surveyed 51,927 people from 57 countries. </span></li>
</ol>
...
<li> Telephone </li>
<li> Internet </li> 
<li> <span class="answer">All of the above</span> </li>
</ol>
...
<ol>
<li> <span class="answer">Countries</span> </li> 
...
<ol>
<li> Countries </li> 
<li> <span class="answer">Individual Persons</span> </li> 
<li> Religions </li>
</ol>
...
**Exercise**: Write out the conditions for inference to construct a 95% confidence interval for the proportion of atheists in the United States in 2012. Are you confident all conditions are met?
  ...
  <p>
  <ul>
  <li>Random sample or assignment</li>
  <li>Sample is less than 10% of population</li>
  <li>We have more than 10 cases "on either side"</li>
  </ul>
...
<div class="answer">
"It means that the true value lies somewhere in that margin."
</div>
</div>

8. Based on the R output, what is the margin of error for the estimate of the proportion of atheists in US in 2012? 
<ol>
...
<li> <span class="answer">The margin of error for the estimate of the proportion of atheists in the US in 2012 is 0.0135.</span> </li>
</ol>
...
<div id="exercise">
**Exercise**: Using the <tt>inference</tt> function, calculate confidence intervals for the proportion of atheists in 2012 in two other countries of your choice, and report the associated margins of error. Be sure to note whether the conditions for inference are met. It may be helpful to create new data sets for each of the two countries first, and then use these data sets in the `inference` function to construct the confidence intervals.
</div>
```{r me-perc-atheist-other-countries}
# type your code for the Exercise here, and Knit
china <- atheism %>% filter(nationality == "China", atheism$year == 2012)
inference(y = response, data = china, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

russia <- atheism %>% filter(nationality == "Russian Federation", atheism$year == 2012)
inference(y = response, data = russia, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
<li> <span class="answer">The most conservative estimate when calculating a confidence interval occurs when $p$ is set to 1.</span> </li>
</ol>
...
# note the answer to "grouping" was to supply the 'x' value, here "year"...
...
ustates <- atheism %>% filter(nationality == "United States")
inference(y = response, x=as.factor(year), data = ustates, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
<li> 0 </li>
<li> 1 </li> 
<li> <span class="answer">1.95</span> </li> 
<li> 5 </li>
</ol>
```{r type1}
...
<li> 9604 people </li> 
<li> <span class="answer">At least 9604 people</span> </li>
</ol>
```{r sample-size}
# type your code for Question 13 here, and Knit

# I have no code for this question, I suppose. There is a way to do this with a package called # 'pwr' but I think this course is failing me on this one.
```
