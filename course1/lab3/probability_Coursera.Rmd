...
<h3 class=arr-me-answer>Answer: A, hit</h3>
...
<ol>
<li> The distribution of Kobe's streaks is unimodal and right skewed. (true) </li>
<li> The typical length of a streak is 0 since the median of the distribution is at 0. (true if you count the streaks) </li>
<li> The IQR of the distribution is 1. (True, see code block following my answer) </li> 
<li> The longest streak of baskets is of length 4. (true) </li>
<li> The shortest streak is of length 1. (False, the shortest streak is zero, no?) </li>
</ol>

<h3>Answer: E, the shortest streak is 1. (It should be zero).</h3>
```{r showing-IQR}
...
<h3>My answer to the exercise:</h3>

```{r sw-table-sim-unfair-coin}
...
<h3>Answer: B, somewhat similar</h3>
...
<h3>Answer: A, the distributions look very similar and no hot hand evidence.</h3>
...
<h3>Answer: Hypothesis testing is what it reminds me of.</h3>
